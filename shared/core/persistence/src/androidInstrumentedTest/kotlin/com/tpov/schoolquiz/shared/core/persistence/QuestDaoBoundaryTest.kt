...
class QuestDaoBoundaryTest {
    ...
    fun setUp() {
        ...
        runBlocking {
            db.catalogDao().insertAll(
                listOf(
                    CatalogEntity(id = "cat1", name = "Cat", picturePath = null, pictureUrl = null),
                    CatalogEntity(id = "cat2", name = "Cat2", picturePath = null, pictureUrl = null),
                )
            )
        }
    }
    ...
    @Test
    fun observeMyQuestsReturnsOnlyMatchingAuthorUid() = runTest {
    ...
    @Test
    fun observeMyQuestsInCatalogFiltersByCatalogId() = runTest {
    ...
    @Test
    fun upsertByIdIfNewerVersionSkipsOnOlderVersion() = runTest {
        upsert(questEntity(id = "q1", version = 5L, title = "original"))
    ...
    @Test
    fun visibleOnSetSurvivesRoundtrip() = runTest {
    ...
    @Test
    fun visibleOnEmptySetSurvivesRoundtrip() = runTest {
