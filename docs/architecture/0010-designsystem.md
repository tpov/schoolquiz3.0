...
## Status
Accepted — 2026-04-16. Палитра и типографика замещены [ADR-0011](0011-noir-designsystem.md) — 2026-08-23. Остальное (движок, роль модулей, правила размещения компонентов) в силе.
