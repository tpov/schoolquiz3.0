...
object CoastValues {
    object CoastValuesNolics {
        ...
        const val COAST_RANDOM_QUIZ8 = 100
        const val COAST_QUIZ8 = 500
        const val COAST_SEND_QUIZ = 500
    }
    ...
    object CoastValuesSkill {
        const val COUNT_COLOR_8 = 1_0000
    }

    object CoastValuesLife {
        const val COAST_LIFE_HOME_QUIZ = 33
        const val COAST_LIFE_ARENA_QUIZ = 33
        const val COAST_LIFE_QUIZ2 = 15
        const val COAST_LIFE_QUIZ3 = 15
        const val COAST_LIFE_QUIZ4 = 25
        const val COAST_LIFE_QUIZ_TRANSLATE1 = 10
        const val VALUE_COUNT_LIFE = 10000
    }
}
